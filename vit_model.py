...
class PatchEmbed(layers.Layer):
    ...
    """
    def __init__(self, img_size1=224,img_size2=224, patch_size1=16,patch_size2=16, embed_dim=768):
        super(PatchEmbed, self).__init__()
        self.embed_dim = embed_dim
        self.img_size = (img_size1, img_size2)
        self.grid_size = (img_size1 // patch_size1, img_size2 // patch_size2)
        self.num_patches = self.grid_size[0] * self.grid_size[1]

        self.proj = layers.Conv2D(filters=embed_dim, kernel_size=(patch_size1,patch_size2),
                                  strides=(patch_size1,patch_size2), padding='SAME',
...
class MLP(layers.Layer):
    ...
    def __init__(self, in_features, mlp_ratio=4.0, drop=0.1, name=None):
...
class VisionTransformer(Model):
    def __init__(self, img_size1=224,img_size2=224,patch_size1=16,patch_size2=16, embed_dim=768,
        ...
        self.patch_embed = PatchEmbed(img_size1=img_size1, img_size2=img_size2,patch_size1=patch_size1,patch_size2=patch_size2, embed_dim=embed_dim)
...
def vit_base_patch16_224_in21k(num_classes: int = 21843, has_logits: bool = True):
    ...
    """
    model = VisionTransformer(img_size1=640,
                              img_size2=18,
                              patch_size1=640,
                              patch_size2=9,
                              embed_dim=192,
                              depth=5,
                              num_heads=8,
                              representation_size=48 if has_logits else None,
